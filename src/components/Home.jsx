...
import CV from '../assets/Anasuya_Roy-FrontendDeveloper.pdf' // Import your CV file
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
          <div data-aos="fade-right" className="w-full md:w-1/2 text-left">
            ...
            <div data-aos="flip-up" className="flex gap-6 mb-8">
            ...
            <a
              href={CV}
              download="Anasuya_Roy-FrontendDeveloper.Pdf" // Suggested filename for the downloaded file
              className="inline-block bg-[#5C4033] text-white px-6 py-3 rounded-lg hover:bg-[#8B6B4E] transition-colors duration-300"
            >
              Download CV
            </a>
          </div>
          <div data-aos="flip-left" className="w-full md:w-1/2">
            <img 
              src={Image}
