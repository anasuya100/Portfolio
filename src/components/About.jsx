  ...
  return (
    <section id="about" className="py-16 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        <h2 data-aos="zoom-in" className="text-3xl font-bold text-[#5C4033] mb-12 text-center">About Me</h2>
        <div className="grid md:grid-cols-3 gap-8">
          <div data-aos="flip-left" className="bg-[#F4E4BC] rounded-lg p-6 shadow-lg transform hover:-translate-y-2 transition-transform duration-300">
          ...
          <div data-aos="flip-up" className="bg-[#F4E4BC] rounded-lg p-6 shadow-lg transform hover:-translate-y-2 transition-transform duration-300">
            <div className="flex items-center gap-4 mb-4">
            ...
            <div data-aos="flip-right" className="bg-[#F4E4BC] rounded-lg p-6 shadow-lg transform hover:-translate-y-2 transition-transform duration-300">
            <div className="flex items-center gap-4 mb-4">
        ...
        <div data-aos="zoom-in-up" className="mt-12 bg-[#F4E4BC] rounded-lg p-8 shadow-lg">
          <h3 className="text-2xl text-center font-semibold text-[#5C4033] mb-4">My Journey</h3>
          <p className="text-gray-700 mb-4">
            I'm a 3rd-year CSE student with a passion for building real-world solutions. I started freelancing early, which helped me sharpen my web development skills and gain hands-on experience beyond the classroom.
